...
const triggerNodes: NodeTypeOption[] = [
  ...
  },
  {
    ...
    label: "When a Google Form is submitted",
    description:
  ...
  },
  {
    ...
    label: "When a Stripe event is received",
    description:
      "Runs the flow when a Stripe event is received. Good for processing payments.",
...
const executionNodes: NodeTypeOption[] = [
  ...
  },
  {
    ...
    label: "Anthropic",
    description: "Uses Anthropic to generate text. Good for generating text.",
    icon: "/logos/anthropic.svg",
  },
  {
    type: NodeType.DISCORD,
    label: "Discord",
    description: "Uses Discord to send a message. Good for sending messages.",
    icon: "/logos/discord.svg",
  },
  {
    type: NodeType.SLACK,
    label: "Slack",
    description: "Uses Slack to send a message. Good for sending messages.",
